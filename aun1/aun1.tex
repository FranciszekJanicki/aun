...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{aun1_imp_mosfet_comparison.png}
...
Dobra tutaj nie mam pojecia bo przy dodaniu kondensatora zwiekszaja sie oscylacje zamiast zmniejszac, pewnie przez pasozytniczosc

Trzeba jeszcze raz policzyc, kiedys jak lizylismy z Kuba to wychodzilo tez gowno ale
nie takie jak mi teraz wychodzi

IDK O CO CHODZI, odlaczylem snubbera i jechalem krok po kroku jak na tym forum
co podlinkowal

Z dokumentacji dobralem C0 na 1nF

Aha i pamietajcie jedno: 
1. dutkeiwicz
2. boltrukiewicz
3. kardys
